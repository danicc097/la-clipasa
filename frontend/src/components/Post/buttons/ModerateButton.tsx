...
import { IconEdit, IconShieldCheck, IconShieldOff, IconTrash } from '@tabler/icons'
import { InfiniteData, useQueryClient } from '@tanstack/react-query'
import { useEffect, useState } from 'react'
import { useStyles } from 'src/components/Post/buttons/styles'
import ProtectedComponent from 'src/components/ProtectedComponent'
import { API_POSTS_KEY, usePostDeleteMutation, usePostPatchMutation } from 'src/queries/api/posts'
